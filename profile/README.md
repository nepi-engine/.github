...
[NEPI_REMOTE_SETUP](https://github.com/nepi-engine/nepi_setup/blob/main/NEPI_REMOTE_SETUP.md)
...
If you just want to pull the latest updates to an existing cloned NEPI repo:
    ...
    git submodule foreach --recursive "git checkout main && git pull origin main" 2> /dev/null


## NEPI Engine Source-Code Overview
...
- [nepi_engine_ws](https://github.com/nepi-engine/nepi_engine_ws) - Super-project for all NEPI Engine source code, including hardware drivers, AI model management system, built-in applications, automation script manager, NEPI SDK and API libraries, and NEPI's resident user interface system. Source code is organized as a collection of git submodules below this superproject.

#### NEPI Engine Submodules

The nepi_engine_ws includes the following submodule component repos
...
- [nepi_setup](https://github.com/nepi-engine/nepi_setup) - Collection of scripts and resources for setting up NEPI remote, host, and system environments.
